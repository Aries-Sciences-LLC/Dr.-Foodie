...
class NutritionFact: UIView {
    func set(_ suggestion: UserNutrition.Suggestion) {
        ...
        attributedFactText.addAttribute(.font, value: UIFont(name: "Futura-Medium", size: 25) ?? UIFont.systemFont(ofSize: 25), range: NSRange(location: 0, length: firstCheckpoint))
        attributedFactText.addAttribute(.font, value: UIFont(name: "Futura-Bold", size: 95) ?? UIFont.boldSystemFont(ofSize: 95), range: NSRange(location: firstCheckpoint, length: lastCheckpoint - firstCheckpoint))
